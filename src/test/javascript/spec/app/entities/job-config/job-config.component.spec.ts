...
import { JobConfigComponent } from 'app/entities/job-config/job-config.component';
...
describe('Component Tests', () => {
  describe('JobConfig Management Component', () => {
    let comp: JobConfigComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JobConfigComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jobConfigs && comp.jobConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
