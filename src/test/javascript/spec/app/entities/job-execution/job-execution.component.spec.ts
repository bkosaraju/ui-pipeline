...
import { JobExecutionComponent } from 'app/entities/job-execution/job-execution.component';
...
describe('Component Tests', () => {
  describe('JobExecution Management Component', () => {
    let comp: JobExecutionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JobExecutionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jobExecutions && comp.jobExecutions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
