...
import { TaskConfigComponent } from 'app/entities/task-config/task-config.component';
...
describe('Component Tests', () => {
  describe('TaskConfig Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskConfigs && comp.taskConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
