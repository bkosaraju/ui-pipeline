...
public class TaskExecutionConfigResourceIT {
    ...
    public void createTaskExecutionConfig() throws Exception {
        ...
        restTaskExecutionConfigMockMvc
            .perform(
                post("/api/task-execution-configs")
                    .with(csrf())
    ...
    public void getAllTaskExecutionConfigs() throws Exception {
        ...
        restTaskExecutionConfigMockMvc
            .perform(get("/api/task-execution-configs?sort=id,desc"))
    ...
    public void getTaskExecutionConfig() throws Exception {
        ...
        restTaskExecutionConfigMockMvc
            .perform(get("/api/task-execution-configs/{id}", taskExecutionConfig.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    @Test
    @Transactional
    public void getAllTaskExecutionConfigsByConfigVersionContainsSomething() throws Exception {
        // Initialize the database
        taskExecutionConfigRepository.saveAndFlush(taskExecutionConfig);

        // Get all the taskExecutionConfigList where configVersion contains DEFAULT_CONFIG_VERSION
        defaultTaskExecutionConfigShouldBeFound("configVersion.contains=" + DEFAULT_CONFIG_VERSION);

        // Get all the taskExecutionConfigList where configVersion contains UPDATED_CONFIG_VERSION
        defaultTaskExecutionConfigShouldNotBeFound("configVersion.contains=" + UPDATED_CONFIG_VERSION);
    }

    @Test
    @Transactional
    public void getAllTaskExecutionConfigsByConfigVersionNotContainsSomething() throws Exception {
        // Initialize the database
        taskExecutionConfigRepository.saveAndFlush(taskExecutionConfig);

        // Get all the taskExecutionConfigList where configVersion does not contain DEFAULT_CONFIG_VERSION
        defaultTaskExecutionConfigShouldNotBeFound("configVersion.doesNotContain=" + DEFAULT_CONFIG_VERSION);

        // Get all the taskExecutionConfigList where configVersion does not contain UPDATED_CONFIG_VERSION
        defaultTaskExecutionConfigShouldBeFound("configVersion.doesNotContain=" + UPDATED_CONFIG_VERSION);
    }
    ...
    private void defaultTaskExecutionConfigShouldBeFound(String filter) throws Exception {
        restTaskExecutionConfigMockMvc
            .perform(get("/api/task-execution-configs?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(taskExecutionConfig.getId().intValue())))
            .andExpect(jsonPath("$.[*].configKey").value(hasItem(DEFAULT_CONFIG_KEY)))
        ...
        restTaskExecutionConfigMockMvc
            .perform(get("/api/task-execution-configs/count?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingTaskExecutionConfig() throws Exception {
        // Get the taskExecutionConfig
        restTaskExecutionConfigMockMvc.perform(get("/api/task-execution-configs/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateTaskExecutionConfig() throws Exception {
        ...
        updatedTaskExecutionConfig.configKey(UPDATED_CONFIG_KEY).configValue(UPDATED_CONFIG_VALUE).configVersion(UPDATED_CONFIG_VERSION);

        restTaskExecutionConfigMockMvc
            .perform(
                put("/api/task-execution-configs")
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteTaskExecutionConfig() throws Exception {
        ...
        restTaskExecutionConfigMockMvc
            .perform(
                delete("/api/task-execution-configs/{id}", taskExecutionConfig.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON)
            )
