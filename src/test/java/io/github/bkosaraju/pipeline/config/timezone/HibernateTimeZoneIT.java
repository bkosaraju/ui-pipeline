package io.github.bkosaraju.pipeline.config.timezone;

import io.github.bkosaraju.pipeline.PipelineApp;
import io.github.bkosaraju.pipeline.repository.timezone.DateTimeWrapper;
import io.github.bkosaraju.pipeline.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ui_date_time_wrapper where id=%d", fieldName, id);
    }
