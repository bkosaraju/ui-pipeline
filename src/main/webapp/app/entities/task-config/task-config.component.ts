...
export class TaskConfigComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.taskConfigService
      ...
      .subscribe(
        (res: HttpResponse<ITaskConfig[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTaskConfigs(): void {
    this.eventSubscriber = this.eventManager.subscribe('taskConfigListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITaskConfig[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
