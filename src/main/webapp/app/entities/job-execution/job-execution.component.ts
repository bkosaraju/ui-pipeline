...
export class JobExecutionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.jobExecutionService
      ...
      .subscribe(
        (res: HttpResponse<IJobExecution[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInJobExecutions(): void {
    this.eventSubscriber = this.eventManager.subscribe('jobExecutionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IJobExecution[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
