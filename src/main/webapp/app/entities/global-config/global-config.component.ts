...
export class GlobalConfigComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.globalConfigService
      ...
      .subscribe(
        (res: HttpResponse<IGlobalConfig[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGlobalConfigs(): void {
    this.eventSubscriber = this.eventManager.subscribe('globalConfigListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGlobalConfig[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
