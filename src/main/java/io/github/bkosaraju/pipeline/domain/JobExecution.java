...
public class JobExecution implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="job_execution_id_seq")
    @SequenceGenerator(name="job_execution_id_seq", sequenceName="job_execution_id_seq", allocationSize=1)
