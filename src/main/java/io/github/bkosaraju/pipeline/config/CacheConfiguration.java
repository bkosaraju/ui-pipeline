...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.github.bkosaraju.pipeline.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.github.bkosaraju.pipeline.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, io.github.bkosaraju.pipeline.domain.User.class.getName());
            createCache(cm, io.github.bkosaraju.pipeline.domain.Authority.class.getName());
